...
- Editor: Vim using [my vimrc](https://github.com/vs1ng/VinayakUsesThisVimrc)

## Code Features

- Paradigm: Object-Oriented Programming (OOP)
- Data Structures: Bytearray (optimization over lists)
- Type System: Strong typing (Type Hints)
- Encapsulation: Private methods, Class-based structure
